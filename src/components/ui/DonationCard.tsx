...
export function DonationCard({ onDonate }: DonationCardProps) {
  return (
    ...
    >
      <div className="aspect-square bg-gradient-to-br from-rose-gold/10 to-blush/50 flex items-center justify-center relative overflow-hidden">
        <div className="relative">
          <Heart className="w-20 h-20 text-rose-gold/40 fill-rose-gold/20" />
          <Heart className="w-10 h-10 text-rose-gold/60 fill-rose-gold/30 absolute -top-2 -right-4 rotate-12" />
        </div>
      </div>
